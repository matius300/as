<?php
  ...
  if ($cfg_use_shortlink) {
    ...
    // Changed to linkrex: http://linkrex.net/ref/japakar
    $cfg_eliwin_key = 'linkrexapikeygoeshere';
  }
  ...
  if ($cfg_enable_google_analytics) {
    $cfg_ga_ID = 'UA-138450615-1'; // your tracking ID
    /* Be sure to go to
  ...
  $cfg_fh_username = 'SIKTER'; // Your FaucetHUB username.
  $cfg_site_name = 'Selow Coffee'; // The faucet name.
  $cfg_site_url = 'https://dsadadszczsdcfsa.000webhostapp.com/'; // The URL of the faucet.
